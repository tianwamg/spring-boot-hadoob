...
public class HiveDatasourceProperties {
    ...
    public int getMaxPoolPrepareStatementPerConnectionSize() {
        return maxPoolPrepareStatementPerConnectionSize;
    }

    public void setMaxPoolPrepareStatementPerConnectionSize(int maxPoolPrepareStatementPerConnectionSize) {
        this.maxPoolPrepareStatementPerConnectionSize = maxPoolPrepareStatementPerConnectionSize;
    }
}
